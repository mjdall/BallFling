...
public class LabFive extends TrackBlueprint {
	...
	protected void setObs () {
		...
		Obstacle z87285209 = new SandStone(6 * gridSize, 0 * gridSize, new Point(1 * gridSize, 1 * gridSize));
		...
		Obstacle z1325895069 = new SandStone(7 * gridSize, 0 * gridSize, new Point(2 * gridSize, 1 * gridSize));
		addToObs(z1325895069, 0);
