...
public class LethalZigZag extends TrackBlueprint {
	public LethalZigZag(Point screenDims) {
	...
	protected void setObs () {
		...
		Obstacle z431358405 = new Water(6 * gridSize, 11 * gridSize, new Point(2 * gridSize, 3 * gridSize));
		...
		Obstacle z596512160 = new Water(1 * gridSize, 4 * gridSize, new Point(1 * gridSize, 1 * gridSize));
		addToObs(z596512160, -1);
		Obstacle z824318977 = new Water(4 * gridSize, 7 * gridSize, new Point(1 * gridSize, 1 * gridSize));
		...
		Obstacle z1550209284 = new Water(3 * gridSize, 6 * gridSize, new Point(1 * gridSize, 3 * gridSize));
		...
		Obstacle z636718843 = new Water(1 * gridSize, 10 * gridSize, new Point(1 * gridSize, 1 * gridSize));
		...
		Obstacle z1775282496 = new Water(7 * gridSize, 10 * gridSize, new Point(1 * gridSize, 1 * gridSize));
		...
		Obstacle z1267032395 = new Water(7 * gridSize, 14 * gridSize, new Point(1 * gridSize, 1 * gridSize));
