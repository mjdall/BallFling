...
public class BraeLevel extends TrackBlueprint {
    public BraeLevel (Point screenDims) {
    ...
    protected void setObs () {
        ...
        Obstacle z1187252184 = new LongGrass(6 * gridSize, 6 * gridSize, new Point(8 * gridSize, 1 * gridSize)); //6,6
        addToObs(z1187252184, 0);
        Obstacle z528006386 = new LongGrass(3 * gridSize, 61 * gridSize, new Point(1 * gridSize, 2 * gridSize)); //3,61
        addToObs(z528006386, 0);
        Obstacle z1147162332 = new LongGrass(13 * gridSize, 9 * gridSize, new Point(3 * gridSize, 1 * gridSize)); //13,9
        addToObs(z1147162332, 0);
        Obstacle z1029847827 = new LongGrass(8 * gridSize, 51 * gridSize, new Point(1 * gridSize, 4 * gridSize)); //8,51
        addToObs(z1029847827, 0);
        Obstacle z686967007 = new LongGrass(9 * gridSize, 50 * gridSize, new Point(1 * gridSize, 4 * gridSize)); //9,50
        addToObs(z686967007, 0);
        Obstacle z1645100802 = new LongGrass(12 * gridSize, 47 * gridSize, new Point(5 * gridSize, 1 * gridSize)); //12,47
        addToObs(z1645100802, 0);
        Obstacle z353471608 = new LongGrass(12 * gridSize, 48 * gridSize, new Point(6 * gridSize, 1 * gridSize)); //12,48
        addToObs(z353471608, 0);
        Obstacle z738320688 = new LongGrass(10 * gridSize, 49 * gridSize, new Point(1 * gridSize, 3 * gridSize)); //10,49
        addToObs(z738320688, 0);
        Obstacle z1202345228 = new LongGrass(7 * gridSize, 53 * gridSize, new Point(1 * gridSize, 3 * gridSize)); //7,53
        addToObs(z1202345228, 0);
        Obstacle z1350764605 = new LongGrass(5 * gridSize, 4 * gridSize, new Point(1 * gridSize, 5 * gridSize)); //5,4
        addToObs(z1350764605, 0);
        Obstacle z1871858955 = new LongGrass(6 * gridSize, 54 * gridSize, new Point(1 * gridSize, 3 * gridSize)); //6,54
        addToObs(z1871858955, 0);
        Obstacle z1680879898 = new LongGrass(11 * gridSize, 48 * gridSize, new Point(1 * gridSize, 3 * gridSize)); //11,48
        addToObs(z1680879898, 0);
        Obstacle z365270375 = new LongGrass(4 * gridSize, 59 * gridSize, new Point(1 * gridSize, 2 * gridSize)); //4,59
        addToObs(z365270375, 0);
        Obstacle z1798905968 = new LongGrass(6 * gridSize, 7 * gridSize, new Point(9 * gridSize, 1 * gridSize)); //6,7
        addToObs(z1798905968, 0);
        Obstacle z641692879 = new LongGrass(6 * gridSize, 4 * gridSize, new Point(5 * gridSize, 1 * gridSize)); //6,4
        addToObs(z641692879, 0);
        Obstacle z1002591512 = new LongGrass(4 * gridSize, 5 * gridSize, new Point(1 * gridSize, 6 * gridSize)); //4,5
        addToObs(z1002591512, 0);
        Obstacle z435507010 = new LongGrass(6 * gridSize, 5 * gridSize, new Point(7 * gridSize, 1 * gridSize)); //6,5
        addToObs(z435507010, 0);
        Obstacle z185074812 = new LongGrass(6 * gridSize, 3 * gridSize, new Point(3 * gridSize, 1 * gridSize)); //6,3
        addToObs(z185074812, 0);
        Obstacle z980858726 = new LongGrass(10 * gridSize, 8 * gridSize, new Point(5 * gridSize, 1 * gridSize)); //10,8
        addToObs(z980858726, 0);
        Obstacle z1437754329 = new LongGrass(3 * gridSize, 8 * gridSize, new Point(1 * gridSize, 5 * gridSize)); //3,8
        addToObs(z1437754329, 0);
        Obstacle z1616472704 = new LongGrass(14 * gridSize, 46 * gridSize, new Point(2 * gridSize, 1 * gridSize)); //14,46
        addToObs(z1616472704, 0);
        Obstacle z947111945 = new LongGrass(12 * gridSize, 49 * gridSize, new Point(5 * gridSize, 1 * gridSize)); //12,49
        addToObs(z947111945, 0);
        Obstacle z1144748400 = new LongGrass(15 * gridSize, 10 * gridSize, new Point(1 * gridSize, 1 * gridSize)); //15,10
        addToObs(z1144748400, 0);
        Obstacle z1672765444 = new LongGrass(5 * gridSize, 56 * gridSize, new Point(1 * gridSize, 3 * gridSize)); //5,56
        ...
        Obstacle z915842245 = new Wall(28 * gridSize, 24 * gridSize, new Point(1 * gridSize, 4 * gridSize)); //28,24
        addToObs(z915842245, 0);
        Obstacle z960050706 = new Wall(2 * gridSize, 14 * gridSize, new Point(1 * gridSize, 4 * gridSize)); //2,14
        addToObs(z960050706, 0);
        Obstacle z571804444 = new Wall(5 * gridSize, 13 * gridSize, new Point(1 * gridSize, 4 * gridSize)); //5,13
        addToObs(z571804444, 0);
        Obstacle z1000960776 = new Wall(20 * gridSize, 46 * gridSize, new Point(2 * gridSize, 1 * gridSize)); //20,46
        addToObs(z1000960776, 0);
        Obstacle z983345036 = new Wall(26 * gridSize, 23 * gridSize, new Point(1 * gridSize, 4 * gridSize)); //26,23
        addToObs(z983345036, 0);
        Obstacle z1736523580 = new Wall(26 * gridSize, 51 * gridSize, new Point(2 * gridSize, 1 * gridSize)); //26,51
        addToObs(z1736523580, 0);
        Obstacle z287209190 = new Wall(18 * gridSize, 48 * gridSize, new Point(2 * gridSize, 1 * gridSize)); //18,48
        addToObs(z287209190, 0);
        Obstacle z2028827245 = new Wall(16 * gridSize, 50 * gridSize, new Point(2 * gridSize, 2 * gridSize)); //16,50
        addToObs(z2028827245, 0);
        Obstacle z217632944 = new Wall(29 * gridSize, 25 * gridSize, new Point(1 * gridSize, 3 * gridSize)); //29,25
        addToObs(z217632944, 0);
        Obstacle z2046901117 = new Wall(3 * gridSize, 34 * gridSize, new Point(3 * gridSize, 3 * gridSize)); //3,34
        addToObs(z2046901117, 0);
        Obstacle z112630952 = new Wall(21 * gridSize, 45 * gridSize, new Point(2 * gridSize, 1 * gridSize)); //21,45
        addToObs(z112630952, 0);
        Obstacle z1729747916 = new Wall(28 * gridSize, 49 * gridSize, new Point(2 * gridSize, 1 * gridSize)); //28,49
        addToObs(z1729747916, 0);
        Obstacle z557427743 = new Wall(27 * gridSize, 50 * gridSize, new Point(2 * gridSize, 1 * gridSize)); //27,50
        addToObs(z557427743, 0);
        Obstacle z1945200969 = new Wall(26 * gridSize, 2 * gridSize, new Point(3 * gridSize, 1 * gridSize)); //26,2
        addToObs(z1945200969, 0);
        Obstacle z717533926 = new Wall(23 * gridSize, 54 * gridSize, new Point(2 * gridSize, 1 * gridSize)); //23,54
        addToObs(z717533926, 0);
        Obstacle z466451752 = new Wall(3 * gridSize, 13 * gridSize, new Point(1 * gridSize, 5 * gridSize)); //3,13
        addToObs(z466451752, 0);
        Obstacle z486562440 = new Wall(25 * gridSize, 24 * gridSize, new Point(1 * gridSize, 2 * gridSize)); //25,24
        addToObs(z486562440, 0);
        Obstacle z648129395 = new Wall(23 * gridSize, 55 * gridSize, new Point(1 * gridSize, 1 * gridSize)); //23,55
        addToObs(z648129395, 0);
        Obstacle z1093434779 = new Wall(27 * gridSize, 23 * gridSize, new Point(1 * gridSize, 5 * gridSize)); //27,23
        addToObs(z1093434779, 0);
        Obstacle z1337821362 = new Wall(10 * gridSize, 24 * gridSize, new Point(2 * gridSize, 4 * gridSize)); //10,24
        addToObs(z1337821362, 0);
        Obstacle z445051664 = new Wall(4 * gridSize, 33 * gridSize, new Point(1 * gridSize, 1 * gridSize)); //4,33
        addToObs(z445051664, 0);
        Obstacle z954410619 = new Wall(25 * gridSize, 1 * gridSize, new Point(4 * gridSize, 1 * gridSize)); //25,1
        addToObs(z954410619, 0);
        Obstacle z97889252 = new Wall(22 * gridSize, 44 * gridSize, new Point(2 * gridSize, 1 * gridSize)); //22,44
        addToObs(z97889252, 0);
        Obstacle z866358686 = new Wall(17 * gridSize, 49 * gridSize, new Point(2 * gridSize, 1 * gridSize)); //17,49
        addToObs(z866358686, 0);
        Obstacle z41745555 = new Wall(21 * gridSize, 55 * gridSize, new Point(2 * gridSize, 2 * gridSize)); //21,55
        addToObs(z41745555, 0);
        Obstacle z1881349304 = new Wall(24 * gridSize, 53 * gridSize, new Point(2 * gridSize, 1 * gridSize)); //24,53
        addToObs(z1881349304, 0);
        Obstacle z141445603 = new Wall(24 * gridSize, 0 * gridSize, new Point(6 * gridSize, 1 * gridSize)); //24,0
        addToObs(z141445603, 0);
        Obstacle z1310919806 = new Wall(12 * gridSize, 25 * gridSize, new Point(1 * gridSize, 3 * gridSize)); //12,25
        addToObs(z1310919806, 0);
        Obstacle z1357681303 = new Wall(19 * gridSize, 47 * gridSize, new Point(2 * gridSize, 1 * gridSize)); //19,47
        addToObs(z1357681303, 0);
        Obstacle z1679617135 = new Wall(29 * gridSize, 47 * gridSize, new Point(2 * gridSize, 2 * gridSize)); //29,47
        addToObs(z1679617135, 0);
        Obstacle z513286419 = new Wall(25 * gridSize, 52 * gridSize, new Point(2 * gridSize, 1 * gridSize)); //25,52
        addToObs(z513286419, 0);
        Obstacle z1438777355 = new Wall(4 * gridSize, 12 * gridSize, new Point(1 * gridSize, 6 * gridSize)); //4,12
        addToObs(z1438777355, 0);
        Obstacle z1498468029 = new Wall(23 * gridSize, 42 * gridSize, new Point(2 * gridSize, 2 * gridSize)); //23,42
        addToObs(z1498468029, 0);
        Obstacle z1679020768 = new Wall(9 * gridSize, 26 * gridSize, new Point(1 * gridSize, 2 * gridSize)); //9,26
